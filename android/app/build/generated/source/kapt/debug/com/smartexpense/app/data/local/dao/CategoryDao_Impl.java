...
public final class CategoryDao_Impl implements CategoryDao {
  ...
  public CategoryDao_Impl(@NonNull final RoomDatabase __db) {
    ...
    this.__insertionAdapterOfCategory = new EntityInsertionAdapter<Category>(__db) {
      ...
      protected String createQuery() {
        return "INSERT OR REPLACE INTO `categories` (`id`,`userId`,`name`,`synced`) VALUES (?,?,?,?)";
      }
  ...
  @Override
  public Object insertAllCategories(final List<Category> categories,
      final Continuation<? super Unit> $completion) {
    return CoroutinesRoom.execute(__db, true, new Callable<Unit>() {
      @Override
      @NonNull
  ...
  @Override
  public Object deleteCategoryById(final String id, final Continuation<? super Unit> $completion) {
    return CoroutinesRoom.execute(__db, true, new Callable<Unit>() {
      @Override
      @NonNull
      public Unit call() throws Exception {
      ...
      public List<Category> call() throws Exception {
        ...
        try {
          ...
          while (_cursor.moveToNext()) {
            ...
            _tmpSynced = _tmp != 0;
            _item = new Category(_tmpId,_tmpUserId,_tmpName,_tmpSynced);
            _result.add(_item);
          }
          return _result;
        } finally {
  ...
  @Override
  public Object getUnsyncedCategories(final Continuation<? super List<Category>> $completion) {
    final String _sql = "SELECT * FROM categories WHERE synced = 0";
    final RoomSQLiteQuery _statement = RoomSQLiteQuery.acquire(_sql, 0);
